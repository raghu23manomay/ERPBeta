	...
	a.fn.smartWizard = function (m) {
		...
		return this.each(function () {
			function C() {
				...
				k = a("<div></div>").addClass("actionBar relPos");
				...
				a(s).click(function () {
					if (!a(this).hasClass("disabled")) if (a.isFunction(c.onFinish)) c.onFinish.call(this, a(f));
					else {
			...
			function w(e) {
				var d = f.eq(e),
					g = f.eq(h);
				if (e != h && a.isFunction(c.onLeaveStep) && !c.onLeaveStep.call(this, a(g))) return !1;
				...
				if ("slide" == c.transitionEffect) a(a(g, b).attr("href"), b).slideUp("fast", function (c) {
					...
					var k = 0;
					e > h ? (nextElmLeft1 = z + 10, nextElmLeft2 = 0, k = 0 - a(a(g, b).attr("href"), b).outerWidth()) : (nextElmLeft1 = 0 - a(a(d, b).attr("href"), b).outerWidth() + 20, nextElmLeft2 = 0, k = 10 + a(a(g, b).attr("href"), b).outerWidth());
				...
				} else a(a(g, b).attr("href"), b).hide(), a(a(d, b).attr("href"), b).show(), h = e, u(g, d);
				return !0
			}
			function u(e, d) {
				...
				!f.hasClass("disabled") || c.enableFinishButton ? a(s).removeClass("disabled") : a(s).addClass("disabled");
