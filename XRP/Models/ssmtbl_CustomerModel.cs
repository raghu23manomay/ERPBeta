...
{
    public class ssmtbl_CustomerModel
    {
        ...
        public List<VendorTypeList> VendorTypeListModel { get; set; }
    }
    ...
    public class Paged_ssmtbl_CustomerModel
    {
        public int TotalRows { get; set; }

        public IEnumerable<ssmtbl_CustomerModel> ssmtbl_CustomerModel { get; set; }
