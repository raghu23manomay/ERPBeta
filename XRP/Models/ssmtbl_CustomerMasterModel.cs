...
{
    public class ssmtbl_CustomerMasterModel
    {
     ...
     public class Paged_ssmtbl_CustomerMasterModel
    {
        public int TotalRows { get; set; }

        public IEnumerable<ssmtbl_CustomerMasterModel> ssmtbl_CustomerMasterModel { get; set; }
